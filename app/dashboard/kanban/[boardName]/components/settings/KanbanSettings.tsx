...
import SettingsColumnsData from "./SettingsColumnsData";

export default function KanbanSettings({ boardId }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mb-6">
          <h2 className="text-lg text-white">Columns</h2>
          <SettingsColumnsData boardId={boardId} />
        </div>
      </div>
    </>
  );
