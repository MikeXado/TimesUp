...
export default React.memo(function PreviewTask({
  task,
  handleClick,
}: {
  ...
  return (
    <div
      className={
        "fixed top-0 left-0 right-0 z-50 flex justify-center items-center bg-black bg-opacity-30  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-full"
      }
    >
