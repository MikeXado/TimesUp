...
export default function Navbar({ currentUser }) {
  return (
    <nav className="absolute top-0 left-0 w-full pl-1 z-5 bg-transparent lg:flex-row lg:flex-nowrap lg:justify-start flex items-center">
      <div className="w-full bg-white mx-autp items-center flex justify-between  lg:flex-nowrap flex-wrap lg:px-5 px-4 py-4">
        {/* Brand */}
        <h1 className="text-blue-900 text-sm uppercase hidden lg:inline-block font-semibold">
          Dashboard
        </h1>
        {/* Form */}
